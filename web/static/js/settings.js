...
async function loadConfig(loadTools = true) {
    try {
        ...
        if (wechatBotAgent) wechatBotAgent.value = wechat.bot_agent || 'MeowCyber/1.0';
        ...
        const config = {
            ...
            robots: {
                ...
                wechat: {
                    ...
                    bot_agent: document.getElementById('robot-wechat-bot-agent')?.value.trim() || 'MeowCyber/1.0',
