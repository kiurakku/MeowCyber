...
function toggleProcessDetails(progressId, assistantMessageId) {
    ...
    if (timeline && timeline.classList.contains('expanded')) {
        setTimeout(() => {
            if (window.MeowCyberChatScroll && typeof window.MeowCyberChatScroll.scrollIntoViewIfFollowing === 'function') {
                window.MeowCyberChatScroll.scrollIntoViewIfFollowing(detailsContainer, { behavior: 'smooth', block: 'nearest' });
...
async function attachRunningTaskEventStream(conversationId) {
    ...
    const attachPromise = (async function () {
        try {
            ...
            if (window.MeowCyberChatScroll && typeof window.MeowCyberChatScroll.onTaskEventStreamBegin === 'function') {
                window.MeowCyberChatScroll.onTaskEventStreamBegin(conversationId, asEl.id, progressId);
            }
            ...
            if (!response.ok) {
                ...
                if (window.MeowCyberChatScroll && typeof window.MeowCyberChatScroll.onTaskEventStreamEnd === 'function') {
                    window.MeowCyberChatScroll.onTaskEventStreamEnd();
                }
                return false;
            }
